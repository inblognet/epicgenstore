...
// NEW: Added RefreshCcw for the Return Period icon in the new trust banner
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-surface-bg text-theme-main font-sans transition-colors duration-300">
      ...
      <section className="py-12 md:py-16 px-4 container mx-auto max-w-7xl">
        <div className="flex items-center justify-between mb-8 md:mb-10 border-b border-theme-border pb-4 transition-colors duration-300">
          <h2 className="text-xl md:text-3xl font-black text-theme-main tracking-[0.2em] uppercase">
            NEW ARRIVALS
          </h2>
          <Link href="/products?sort=newest" className="text-theme-muted hover:text-brand font-black text-[10px] md:text-xs uppercase tracking-[0.1em] flex items-center gap-1.5 transition-colors duration-300 group">
              ...
              <div key={product.id} className="h-full bg-transparent border border-theme-border rounded-xl md:rounded-2xl overflow-hidden hover:border-brand/50 transition-all group flex flex-col shadow-sm hover:shadow-xl duration-300">
                <Link href={`/product/${product.slug}`} className="block relative aspect-[4/5] bg-transparent overflow-hidden border-b border-theme-border shrink-0 transition-colors duration-300 group/img">
                  ...
                  <div className="absolute top-2 left-2 md:top-4 md:left-4 flex flex-col gap-1 md:gap-2 z-10 pointer-events-none">
                    <span className="bg-brand text-black text-[8px] md:text-[10px] font-black px-1.5 md:px-2 py-0.5 md:py-1 rounded shadow-md tracking-wider w-fit">NEW</span>
                  </div>
      ...
      <section className="py-12 md:py-20 px-4 container mx-auto max-w-6xl">
        <div className="text-center mb-10 md:mb-12">
          <h2 className="text-2xl md:text-3xl font-black mb-2 text-theme-main tracking-[0.2em] uppercase">WHY CHOOSE US?</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {[
            ...
            <div key={feature.title} className="bg-transparent border border-theme-border rounded-2xl p-6 flex flex-col items-center text-center hover:border-brand/50 hover:shadow-xl transition-all duration-300">
              <feature.icon className="h-8 w-8 md:h-10 md:w-10 text-brand mb-4 transition-colors duration-300" />
      ...
      <section className="py-16 px-4 bg-surface-card/10 border-y border-theme-border transition-colors duration-300">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="flex items-center justify-between mb-8 md:mb-10 border-b border-theme-border pb-4 transition-colors duration-300">
            ...
            <Link href="/products?onSale=true" className="text-theme-muted hover:text-brand font-black text-[10px] md:text-xs uppercase tracking-[0.1em] flex items-center gap-1.5 transition-colors duration-300 group">
              View All <ChevronRight className="w-3 h-3 md:w-4 md:h-4 text-theme-muted group-hover:text-brand transition-colors"/>
            </Link>
          </div>
      ...
      {/* --- NEW: PRE-FOOTER TRUST BANNER & SECURE CHECKOUT BADGES --- */}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0 lg:divide-x divide-theme-border">
            ...
            <div className="flex flex-col items-center text-center px-4">
              <Truck className="w-8 h-8 text-brand mb-4 transition-colors duration-300" />
              <h4 className="text-theme-main font-black uppercase tracking-widest text-xs md:text-sm mb-2">Islandwide Shipping</h4>
              <p className="text-theme-muted text-[10px] md:text-xs font-medium">Enjoy free delivery on every order above 100,000.</p>
            </div>

            <div className="flex flex-col items-center text-center px-4">
              <RefreshCcw className="w-8 h-8 text-brand mb-4 transition-colors duration-300" />
              <h4 className="text-theme-main font-black uppercase tracking-widest text-xs md:text-sm mb-2">Money-Back Guarantee</h4>
              <p className="text-theme-muted text-[10px] md:text-xs font-medium">3-day money back guarantee.</p>
            </div>

            <div className="flex flex-col items-center text-center px-4">
              <ShieldCheck className="w-8 h-8 text-brand mb-4 transition-colors duration-300" />
              <h4 className="text-theme-main font-black uppercase tracking-widest text-xs md:text-sm mb-2">Secure Payments</h4>
          ...
          <div className="mt-12 md:mt-16 flex flex-col items-center gap-6 border-t border-theme-border/50 pt-10">
            <span className="text-[10px] md:text-xs font-black uppercase tracking-widest text-theme-main flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 md:w-5 md:h-5 text-green-500" /> Guarantee Safe & Secure Checkout
            </span>

            <div className="flex flex-wrap justify-center gap-3 opacity-80 hover:opacity-100 transition-opacity duration-300">
              ...
              {/* UNIONPAY */}
              <div className="bg-white w-12 h-8 md:w-14 md:h-9 rounded flex items-center justify-center shadow-md border border-zinc-200 overflow-hidden relative">
  ...
  return (
    <section key={id} className="py-16 px-4 container mx-auto max-w-7xl">
      <div className="flex items-center justify-between mb-8 md:mb-10 border-b border-theme-border pb-4 transition-colors duration-300">
        ...
        <Link href={`/products?category=${categorySlug}`} className="text-theme-muted hover:text-brand font-black text-[10px] md:text-xs uppercase tracking-[0.1em] flex items-center gap-1.5 transition-colors duration-300 group">
          View All <ChevronRight className="w-3 h-3 md:w-4 md:h-4 text-theme-muted group-hover:text-brand transition-colors"/>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 items-stretch">
        ...
        <div className={`col-span-2 lg:col-span-1 min-h-[250px] lg:min-h-full rounded-xl md:rounded-2xl border border-theme-border transition-colors duration-300 relative overflow-hidden flex items-end p-6 md:p-8 flex-col shadow-2xl order-1 ${isBannerRight ? 'lg:order-last' : 'lg:order-first'}`}>
          <div className="absolute inset-0 z-0">
            {/* eslint-disable-next-line @next/next/no-img-element */}
        ...
        {displayProducts.map(product => {
          ...
          return (
            <div key={product.id} className="order-2 h-full bg-transparent border border-theme-border rounded-xl md:rounded-2xl overflow-hidden hover:border-brand/50 transition-all group flex flex-col shadow-sm hover:shadow-xl duration-300">
              <Link href={`/product/${product.slug}`} className="block relative aspect-[4/5] bg-transparent overflow-hidden border-b border-theme-border shrink-0 transition-colors duration-300 group/img">
                {product.imageUrl ? (
                  <>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
